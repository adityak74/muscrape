...
if __name__ == "__main__":
    ...
    input_folder = "/Users/aditya.karnam/Personal/muscrape/enriched_comments"  # Replace with the folder containing your CSV files
    output_file = "/Users/aditya.karnam/Personal/muscrape/muscrape/data/enriched_comments.csv"  # Replace with the desired output file name
